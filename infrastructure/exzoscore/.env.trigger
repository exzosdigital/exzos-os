...
DATABASE_URL=postgresql://postgres:unsafe-postgres-pw@trigger_postgres:5432/main?schema=public&sslmode=disable
DIRECT_URL=postgresql://postgres:unsafe-postgres-pw@trigger_postgres:5432/main?schema=public&sslmode=disable
...
CLICKHOUSE_URL=http://default:password@trigger_clickhouse:8123?secure=false
RUN_REPLICATION_CLICKHOUSE_URL=http://default:password@trigger_clickhouse:8123
...
DOCKER_REGISTRY_URL=trigger_registry:5000
